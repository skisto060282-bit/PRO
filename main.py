...
def start_message(message):
    ...
    # رسالة ترحيبية مختصرة مع تعليمات
    welcome_msg = "🎯 **بوت الفحص الذكي للبروكسيات**\n\n⚡ **المميزات:**\n• فحص HTTP • HTTPS • CONNECT\n• تصنيف تلقائي للقوة 💪🔸🔻\n• نتائج سريعة وموثوقة\n\n📋 اختر أحد الإجراءات أدناه:"

    # ---------------- Inline buttons (مباشرة تحت الرسالة) ----------------
    ...
    # نرسل رسالة لتثبيت شريط الأزرار السفلي
